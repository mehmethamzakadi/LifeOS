...
/// </summary>
public sealed class UpdateCategoryEventHandler : INotificationHandler<DomainEventNotification<CategoryUpdatedEvent>>
{
    private readonly ILogger<UpdateCategoryEventHandler> _logger;
    private readonly ICacheService _cacheService;

    public UpdateCategoryEventHandler(
        ILogger<UpdateCategoryEventHandler> logger,
