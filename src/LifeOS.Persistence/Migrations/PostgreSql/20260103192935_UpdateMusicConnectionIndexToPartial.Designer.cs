...
namespace LifeOS.Persistence.Migrations.PostgreSql
{
    ...
    [Migration("20260103192935_UpdateMusicConnectionIndexToPartial")]
    partial class UpdateMusicConnectionIndexToPartial
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LifeOS.Domain.Entities.MusicConnection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SpotifyUserEmail")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.ToTable("MusicConnections", (string)null);
                });

            modelBuilder.Entity("LifeOS.Domain.Entities.MusicListeningHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("MusicListeningHistory", (string)null);
                });
            ...
            modelBuilder.Entity("LifeOS.Domain.Entities.SavedTrack", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LifeOS.Domain.Entities.MusicConnection", b =>
                {
                    b.HasOne("LifeOS.Domain.Entities.User", null)
                        .WithMany()
