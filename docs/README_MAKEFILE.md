...
LifeOS için oluşturulmuş Makefile ve Windows Batch script'i ile projeyi kolayca yönetebilirsiniz.
...
**Not:** Bu Makefile ve batch script'i LifeOS projesine özeldir. Farklı projeler için uyarlamanız gerekebilir.
